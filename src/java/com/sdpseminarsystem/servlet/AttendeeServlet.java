				...
				DAOFactory.getInstanceOfAttendeeDAO().create(attendee, Integer.valueOf(request.getParameter("seminarId")));
                    ...
                    + "\" title=\"Close Page\">Return</button>");
                                ...
                                if(attendee != null){
                                    ...
                                    out.print("<div class='registerEdit-submit'><input name='submit' type='submit' onclick=\"document.getElementById('hiddenFlag').value='Confirm';document.getElementById('seminarEditConfirm').style.display='block';\" value='Confirm'></div>");
                                    out.print("<div class='registerEdit-cancel'><input name='submit' type='button' onclick=\"document.getElementById('seminarRegisterEdit').style.display='none'\" value='Cancel'></div>");
                                ...
                                if(attendee == null || attendee.getAttendeeEmail().equalsIgnoreCase(request.getParameter("target"))){
                                    ...
                                    response.getWriter().print("<p style='color:red'>Email already registered! Please try again</p>");
                                    response.getWriter().print("<button type='button' onclick=\"document.getElementById('seminarEditConfirm').style.display='none';"
                        + "\" title=\"Close Page\">Return</button>");
                                }
